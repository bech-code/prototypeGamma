#!/usr/bin/env python3
"""
Script de test qui fonctionne pour simuler un paiement et créer un abonnement.
"""
...
def test_payment_working():
    print(f"\n🔄 Test de paiement fonctionnel pour le technicien : {TECHNICIAN_EMAIL}")
    ...
    # Créer ou récupérer le Technician
