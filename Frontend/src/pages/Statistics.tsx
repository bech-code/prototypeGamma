            ...
            <div className="bg-white shadow-sm border-b">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                    <div className="flex items-center justify-between">
                        <div>
                            <h1 className="text-3xl font-bold text-gray-900">Statistiques du Projet</h1>
                            <p className="mt-2 text-gray-600">
                                Vue d'ensemble complète avec ApexCharts - Graphiques interactifs et animations fluides
                            </p>
                        </div>
                            ...
                            {user?.user_type === 'admin' && (
                                <div className="mt-4 flex gap-2 justify-end">
                                    <button
                                        ...
                                        className="inline-flex items-center px-3 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 text-sm font-medium shadow disabled:opacity-50"
                                    ...
                                    <button
                                        ...
                                        className="inline-flex items-center px-3 py-2 bg-red-600 text-white rounded hover:bg-red-700 text-sm font-medium shadow disabled:opacity-50"
                                        disabled={exporting !== 'none'}
                                    ...
                                    {exporting !== 'none' && (
                                        <span className="ml-2 text-blue-600 animate-pulse">Téléchargement en cours...</span>
                                    )}
                                </div>
                            )}
                        </div>
